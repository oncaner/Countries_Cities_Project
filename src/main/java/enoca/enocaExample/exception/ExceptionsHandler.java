package enoca.enocaExample.exception;
...
public class ExceptionsHandler {
    ...
    public ProblemDetails handleCityNotFoundException(CityNotFoundException cityNotFoundException) {
        ProblemDetails problemDetails = new ProblemDetails();
        problemDetails.setMessage(cityNotFoundException.getMessage());
    ...
    @ExceptionHandler
    @ResponseStatus(code = HttpStatus.BAD_REQUEST)
    public ProblemDetails handleCountryNotFoundException(CountryNotFoundException countryNotFoundException) {
        ProblemDetails problemDetails = new ProblemDetails();
        problemDetails.setMessage(countryNotFoundException.getMessage());
